...
/**
 * Props interface of {@link FlowBuilderCoreContext}
 */
export interface FlowBuilderCoreContextProps {
  /**
...
/**
 * Context object for managing the flow builder core context.
 */
...
export default FlowBuilderCoreContext;
