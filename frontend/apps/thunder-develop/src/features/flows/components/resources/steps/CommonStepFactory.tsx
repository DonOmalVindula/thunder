 ...
 */
function CommonStepFactory({resources, data, ...rest}: CommonStepFactoryPropsInterface): ReactElement | null {
  if (resources && resources[0].type === StepTypes.View) {
    return <View resources={resources} data={data} {...rest} />;
  }
  ...
  if (resources && resources[0].type === StepTypes.End) {
    return <End resources={resources} {...rest} />;
  }
