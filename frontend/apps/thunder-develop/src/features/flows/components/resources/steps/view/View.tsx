...
import {Box, FormGroup, IconButton, Paper, Tooltip, Typography} from '@wso2/oxygen-ui';
...
import {useEffect, type HTMLAttributes, type MouseEvent, type ReactElement} from 'react';
...
export interface ViewPropsInterface
  extends Pick<CommonStepFactoryPropsInterface, 'resources'>,
