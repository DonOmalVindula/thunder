...
import {tn, TemplateLiteralType} from '@thunder/utils';
...
export default function SignInBox(): JSX.Element {
  ...
  return (
    <Stack gap={2} className={tn('SignInBox--root')}>
      <ColorSchemeImage
        className={tn('SignInBox--logo')}
        src={{
      ...
      />
      <StyledPaper variant="outlined" className={tn('SignInBox--paper')}>
        <SignIn>
